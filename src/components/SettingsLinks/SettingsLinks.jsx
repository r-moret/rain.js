...
export function SettingsLinks({ settings, saveSettings }) {
    ...
    const handleFormChange = (index, e) => {
        ...
        setModSettings(prevSettings => {
            const newSettings = deepcopy(prevSettings) // Decouple global settings from modified ones
            newSettings.links[index][modifiedField] = e.target.value
    ...
    const handleSaveClick = () => saveSettings(modSettings)
